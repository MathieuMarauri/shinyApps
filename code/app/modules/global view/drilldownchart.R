          ...
          drilldown = JS(
            "function(e){
              ...
              if (e.point.name == 'chrome') {
                ...
                image = 'http://pngimages.net/sites/default/files/blue-ie-logo-png-image-45598.png';
              } else if (e.point.name == 'firefox') {
                image = 'http://pngimg.com/uploads/firefox/firefox_PNG21.png';
              } else if (e.point.name == 'safari') {
                image = 'http://pngimg.com/uploads/safari/safari_PNG12.png';
              } else if (e.point.name == 'opera') {
                image = 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Opera_O.png/480px-Opera_O.png';
              }
              $('#drilldownchart_ui-piechart').css('background', 'url(' + image + ') no-repeat 50% 50%').css('background-size', '13%');
             }"
          ),
          drillup = JS(
            "function(e) { 
